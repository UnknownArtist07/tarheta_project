...
class TarhetaAccount(models.Model):
	...
	display_handle = models.CharField(max_length=80, blank=True)
	card_tagline = models.CharField(max_length=150, blank=True)
	location = models.CharField(max_length=120, blank=True)
	pronouns = models.CharField(max_length=40, blank=True)
	card_visible_fields = models.JSONField(default=list, blank=True)
...
class HubCard(models.Model):
	...
	card_theme = models.CharField(max_length=20, default='paper')
	inherit_theme = models.BooleanField(default=True)
